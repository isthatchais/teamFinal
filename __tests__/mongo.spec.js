...
describe('insert', () => {
  ...
  it(
    ...
    it(
      'should insert a new mood into the moods collection',
      async () => {
    ...
    it(
      'should insert a new entry into the entries collection',
      async () => {
    ...
    it(
      'should insert a new journal into the journals collection',
      async () => {
